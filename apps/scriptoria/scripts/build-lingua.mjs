...
<script>(function(){try{var m=(location.hash||'').match(/theme=(dark|light)/);if(!m)return;var t=m[1];var k='latina_state';var s={};try{s=JSON.parse(localStorage.getItem(k))||{};}catch(e){}s.darkMode=(t==='dark');localStorage.setItem(k,JSON.stringify(s));}catch(e){}})();</script>
