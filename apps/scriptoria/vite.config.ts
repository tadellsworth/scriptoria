  ...
  plugins: [
    ...
    VitePWA({
      ...
      workbox: {
        ...
        // Vigor apps, the static Line of Authority page, and the Learn Thai PWA;
        // without these denials a first visit to any of them could be served
        // Scriptoria's app shell instead of its own page.
        navigateFallbackDenylist: [/^\/scriptoria\/lingua\//, /^\/scriptoria\/lumen\//, /^\/scriptoria\/bloom\//, /^\/scriptoria\/vigor\//, /^\/scriptoria\/line-of-authority\//, /^\/scriptoria\/learn-thai\//],
