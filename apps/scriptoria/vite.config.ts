  ...
  plugins: [
    ...
    VitePWA({
      ...
      workbox: {
        ...
        // embedded Latin course (/scriptoria/lingua/), the separate Lumen, Bloom and
        // Vigor apps, the static Line of Authority page, and the Learn Thai and
        // Habla PWAs; without these denials a first visit to any of them could be
        // served Scriptoria's app shell instead of its own page.
        navigateFallbackDenylist: [/^\/scriptoria\/lingua\//, /^\/scriptoria\/lumen\//, /^\/scriptoria\/bloom\//, /^\/scriptoria\/vigor\//, /^\/scriptoria\/line-of-authority\//, /^\/scriptoria\/learn-thai\//, /^\/scriptoria\/habla\//],
